...
console.log("om")
        try {
            ...
            const response: Response = await fetch(`${import.meta.env.VITE_BACKEND_URL}api/v1/superadmin//resethospitalsuperadminpassword/${props.id}`, {
                method: 'PUT',
                headers: {
    ...
    return (
        <Dialog.Root size={'xs'} open={props.isOpen}>
